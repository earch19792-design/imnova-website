...
export function getNormalizedInventoryContext(
  ...
  if (numericQuantity !== null) {
    ...
    return {
      ...
      stock_message:
        inventoryQuantity > 0
          ? `Cantidad: ${inventoryQuantity.toLocaleString("en-US")} unidades.`
...
export function getRadarAdvisorEvent(
  ...
  if (
    ...
    alert.proposed_next_step =
      "Validar unidades manualmente antes de listar, escalar campaña o crear packs 6/12. Pack 2/3 solo como análisis teórico si es consumible."
  }
