...
function deriveRadarAdvisorReviewQueue({
  ...
  if (
    ...
    return {
      ...
      seller_priority:
        "Urgente",
      seller_reason:
        "Producto listado con stock bajo",
      seller_next_step:
  ...
  if (
    ...
    return {
      ...
      seller_reason:
        isAdvancedCandidate
          ? "Producto avanzado con stock bajo"
          : "Stock bajo o bajando rapido",
      seller_next_step:
        isAdvancedCandidate
          ? "Confirmar stock manual antes de avanzar."
  ...
  if (
    ...
    return {
      ...
      seller_next_step:
        "Abrir en Pipeline y reprocesar. Si ahora pasa stock, margen, riesgo y estrategia, puede salir de bloqueado.",
    }
  }
  ...
  if (
    ...
    return {
      ...
      seller_priority:
        "Alta",
      seller_reason:
        "Bajo costo en producto ya evaluado",
      seller_next_step:
        "Reanalizar margen.",
    }
  }
  ...
  if (hasAmbiguousStock) {
    return {
      ...
      seller_reason:
        isAdvancedCandidate
          ? "Producto avanzado con stock no confirmado"
          : "Stock no confirmado",
      seller_next_step:
        isAdvancedCandidate
          ? "Confirmar disponibilidad antes de avanzar."
  ...
  return {
    ...
    seller_priority:
      "Baja",
    seller_reason:
      "Producto nuevo sin riesgo operativo actual",
    seller_next_step:
      "Evaluar cuando haya tiempo.",
  }
}
