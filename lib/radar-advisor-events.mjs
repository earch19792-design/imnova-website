...
function getRadarSellerRiskSignal(
  ...
  if (
    ...
    return {
      ...
      seller_risk_summary:
        "Validar hazmat/aerosol, carrier y politica de envio antes de tratarlo como candidato vendible.",
  ...
  if (
    ...
    return {
      ...
      seller_risk_summary:
        "Validar marca, UPC, compatibilidad y restricciones antes de preparar titulo o listing.",
      seller_risk_severity:
        "medium",
    }
  }
  ...
  if (
    ...
    return {
      seller_risk_label:
        "Compliance / claims",
      seller_risk_summary:
        "Validar categoria, claims, ingredientes y restricciones de eBay antes de preparar listing.",
      seller_risk_severity:
        "high",
    }
  }
...
function deriveRadarEventIntelligence({
  ...
  if (hasAmbiguousStock) {
    return {
      event_intelligence_label:
        "Validacion manual",
      event_intelligence_summary:
        "Stock no confirmado por variante: buscar SKU/parte y confirmar cantidad real antes de decidir.",
      event_intelligence_severity:
        "high",
      event_intelligence_advisory_only:
        true,
  ...
  return {
    event_intelligence_label:
      "Evento monitoreado",
    event_intelligence_summary:
      "Evento registrado para seguimiento. No ejecuta acciones reales.",
    event_intelligence_severity:
      "low",
    event_intelligence_advisory_only:
      true,
...
export function getRadarAdvisorEvent(
  ...
  if (
    ...
    alert.advisor_message =
      "Stock no confirmado por variante. No listar ni escalar hasta validar cantidad real del SKU."
    alert.proposed_next_step =
      "Buscar SKU o numero de parte en Radar y confirmar cantidad real antes de Price Intelligence o listing."
  }
  ...
  if (
    ...
    alert.advisor_message =
      `Luna muestra ${quantityLabel} unidades a nivel producto; falta validar cantidad por variante.`
    alert.proposed_next_step =
      "Buscar SKU o numero de parte en Radar y validar inventario por variante antes de listar o escalar."
  }
  ...
  if (
    ...
    alert.proposed_next_step =
      "Mantener bloqueado. Buscar SKU o numero de parte en Radar y confirmar stock real antes de reabrir."
  }
