...
const EBAY_CATEGORY_FEE_RULES = [
  {
    category_group:
      "books_music_movies",
    category_match:
      "books|book|music|movie|movies|film|films|dvd|blu-ray|media",
    final_value_fee_percent:
      14.95,
    notes:
  ...
  },
  {
    category_group:
      "wallets_jewelry",
    category_match:
      "wallet|wallets|purse|handbag|handbags|jewelry|jewellery|joyeria|cartera|carteras",
    final_value_fee_percent:
      15,
    notes:
  ...
  },
  {
    category_group:
      "heavy_machinery",
    category_match:
      "heavy machinery|machinery|maquinaria|industrial equipment",
    final_value_fee_percent:
      3,
    notes:
...
function ruleMatches(rule, categoryText, totalRevenue) {
  if (!categoryText) {
    return false
  }
...
export function resolveEbayFeeRule(candidate = {}, totalRevenue = 0, config = {}) {
  const defaultRule = {
    ...
    final_value_fee_percent:
      toNumber(config.ebayFeePercent) ??
      DEFAULT_EBAY_FEE_RULE.final_value_fee_percent,
    fixed_order_fee:
      toNumber(config.ebayFixedOrderFee) ??
      DEFAULT_EBAY_FEE_RULE.fixed_order_fee,
  }
...
export function calculateEbayFee(totalRevenue, feeRule) {
  return roundMoney(
    totalRevenue *
      (feeRule.final_value_fee_percent / 100) +
      feeRule.fixed_order_fee
  )
}
