...
function resolveEbayFeeRule(candidate = {}, totalRevenue = 0, assumptions = {}) {
  const defaultRule = {
    ...DEFAULT_EBAY_FEE_RULE,
    final_value_fee_percent:
      toNumber(assumptions.ebayFeePercent) ??
...
function calculateEbayFee(totalRevenue, feeRule) {
  return roundMoney(
    totalRevenue *
...
function buildStrategicSummary({
  ...
  return {
    ...
    why:
      "Aun falta confirmar si el margen, mercado y datos operativos sostienen una publicacion segura.",
    recommended_action:
