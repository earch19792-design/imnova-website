...
test('per-image pending state requires durable queue; rejected/discarded assets never pending and green requires official readback',()=>{
 ...
 assert.equal(proposalDeliveryStatusV1({state:'SYNCED',officialReadback:false}).kind,'ATTENTION')
 assert.equal(proposalDeliveryStatusV1({state:'SYNCED',officialReadback:true}).kind,'SYNCED')
