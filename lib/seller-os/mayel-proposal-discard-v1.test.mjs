...
import { proposalSlotLabelV1 } from './mayel-gallery-presentation-v1.ts'
...
test('friendly labels separate proposed addition and replacement from original eBay positions',()=>{
 ...
 for(const text of ['ANTES · Última galería verificada de eBay','DESPUÉS · Preview de Mayel','Descartar propuesta','Propuestas descartadas · historial','No confirma que las imágenes ya estén en eBay.'])assert.ok(ui.includes(text))
