...
export const SELLER_OS_NAVIGATION: readonly SellerOsNavigationItem[] = Object.freeze([
  { id: "monitor", label: "Monitor", mobileLabel: "Monitor", description: "Aquí ves cómo está la cuenta, qué cambió y qué necesita atención.", objective: "Decidir dónde actuar primero con evidencia clara.", icon: "monitor", href: "/admin/ebay/monitor", group: "COMMAND", mobilePrimary: true, section: "SELLER_OS", permission: "ADMIN", featureRequirement: "EBAY_READ_ONLY", visibility: "AUTHENTICATED_ADMIN", order: 1, status: "ACTIVE" },
