...
export const SELLER_OS_NAVIGATION: readonly SellerOsNavigationItem[] =
  Object.freeze([
    ...
    { id: "publish", label: "Publicar", mobileLabel: "Publicar",
      ...
      icon: "publish", href: "/admin/ebay/publish", tier: "PRIMARY",
      children: children(
        { id: "publish-prepare", label: "Preparar productos",
          href: "/admin/ebay/quick-pick", capability: "QUICK_PICK_PREPARATION",
          status: "ACTIVE" },
        { id: "publish-journey", label: "Recorrido por producto",
          href: "/admin/ebay/publish#quick-pick-ready",
          capability: "PRODUCT_JOURNEY_TRACE", status: "ACTIVE" },
        { id: "publish-ready", label: "Listos",
          href: "/admin/ebay/publish#quick-pick-ready",
          capability: "OWNER_READY_REVIEW", status: "ACTIVE" },
        { id: "publish-needs-data", label: "Datos por confirmar",
          href: "/admin/ebay/publish#quick-pick-needs-data",
          capability: "OWNER_FACT_EXCEPTIONS", status: "ACTIVE" },
        { id: "publish-batch", label: "Publicación por lote",
          href: "/admin/ebay/publish", capability: "BATCH_PUBLISHER",
          status: "ACTIVE" },
        { id: "publish-running", label: "En ejecución",
          href: "/admin/ebay/publish#quick-pick-in-progress",
          capability: "PUBLISH_EXECUTIONS", status: "ACTIVE" },
        { id: "publish-blocked", label: "Bloqueados",
          href: "/admin/ebay/publish#quick-pick-blocked",
          capability: "PUBLISH_BLOCKERS", status: "ACTIVE" },
        { id: "publish-published", label: "Publicados",
          href: "/admin/ebay/publish#quick-pick-published",
          capability: "PUBLISHED_READBACK", status: "ACTIVE" },
        { id: "publish-history", label: "Historial",
          href: "/admin/ebay/publish#quick-pick-history",
