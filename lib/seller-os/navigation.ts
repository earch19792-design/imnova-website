...
export type SellerOsNavigationItem = Readonly<{
  ...
  description: string
  objective: string
  icon: "monitor" | "bolt" | "file" | "sparkles" | "flask" | "inventory" |
...
export const SELLER_OS_NAVIGATION: readonly SellerOsNavigationItem[] = Object.freeze([
  { id: "monitor", label: "Hoy", mobileLabel: "Hoy", description: "Aquí ves qué necesita atención y entras a cada herramienta de Seller OS.", objective: "Decidir y actuar desde un único punto de entrada.", icon: "monitor", href: "/admin", group: "COMMAND", mobilePrimary: true, section: "SELLER_OS", permission: "ADMIN", featureRequirement: "EBAY_READ_ONLY", visibility: "AUTHENTICATED_ADMIN", order: 1, status: "ACTIVE" },
  { id: "quick-pick", label: "Quick Pick", mobileLabel: "Quick Pick", description: "Aquí pegas productos Luna y sigues cada preparación hasta que esté lista para revisar.", objective: "Convertir una identidad Luna exacta en una oportunidad evaluada usando el Golden Path existente.", icon: "bolt", href: "/admin/ebay/quick-pick", group: "SALES", mobilePrimary: true, section: "SELLER_OS", permission: "ADMIN", featureRequirement: "SELLER_OPERATIONS", visibility: "AUTHENTICATED_ADMIN", order: 2, status: "ACTIVE" },
...
export const SELLER_OS_PRIMARY_NAVIGATION = SELLER_OS_MOBILE_NAVIGATION
