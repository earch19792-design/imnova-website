...
test('VISUAL_STATUS_COLORS_AND_LABELS_PASS all presentation states require icon and text',()=>{
 assert.deepEqual(Object.values(VISUAL_STATUS_DESIGN_V1).map(v=>v.color),['blue','violet','teal','amber','orange','green','amber','amber','red'])
 ...
 assert.equal(visualAssetStatusV1({...base,savedToSellerOS:true,qaPassed:true}).status,'AUTOMATIC_REVIEW')
})
