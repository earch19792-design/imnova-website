...
test('exposure is explicit package/identity/Truth scoped, never inferred from availability',()=>{
 ...
 assert.equal(policy({...f.exposure,sourcePolicy:'SELLER_OS_CURRENT_FACTORY_ROUTINE_EXPOSURE_AUTHORITY_V1',
  authorizedBy:'SELLER_OS_CURRENT_PUBLICATION_FACTORY_V1',authorizationReference:'CURRENT_FACTORY_GENERATION:24535b37-0335-4984-a36c-dbb73a7560da'},f.binding).valid,true)
 assert.equal(policy({...f.exposure,sourcePolicy:'SELLER_OS_CURRENT_FACTORY_ROUTINE_EXPOSURE_AUTHORITY_V1',
  authorizedBy:'owner',authorizationReference:'CURRENT_FACTORY_GENERATION:24535b37-0335-4984-a36c-dbb73a7560da'},f.binding).valid,false)
 assert.equal(policy({...f.exposure,sourcePolicy:'SELLER_OS_CURRENT_FACTORY_ROUTINE_EXPOSURE_AUTHORITY_V1',
  authorizedBy:'SELLER_OS_CURRENT_PUBLICATION_FACTORY_V1',authorizationReference:'arbitrary'},f.binding).valid,false)
