...
function database(f){
 ...
 const b=f.binding
 const tables={ebay_current_listing_packages_v1:{id:f.packageId,factory:f.factory,opportunity_id:b.OPPORTUNITY_ID,candidate_key:b.CANDIDATE_KEY,account_key:b.ACCOUNT_KEY,ownPrice:f.ownPrice,category:f.category},ebay_luna_opportunity_queue:{id:b.OPPORTUNITY_ID,candidate_key:b.CANDIDATE_KEY,supplier_product_id:b.PRODUCT_ID,supplier_variant_id:b.VARIANT_ID,supplier_sku:"OUR-SKU",shippingFamily:"market-family-v1:sha256:"+"e".repeat(64),truthFields:f.truthFields,requiredTruth:f.requiredTruth,aspectResolutions:f.aspectResolutions},seller_os_product_research_canonical_evidence_v2:f.reference}
