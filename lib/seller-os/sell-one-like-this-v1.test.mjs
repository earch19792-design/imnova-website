...
function database(f){
 ...
 }assert.equal(name,"read_product_research_keyword_handoff_v1");assert.equal(args.p_variant_id,b.VARIANT_ID);return Promise.resolve({data:f.keywordRead,error:null})}}
