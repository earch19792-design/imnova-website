...
test("cold start keeps TEST and allows proven economic simulation without authorizing spend", () => {
  ...
  assert.equal(treatment.treatment, "TEST"); assert.equal(treatment.promotion.status, "SIMULATION_READY")
