...
test("terminal authorized batch states remain immutable to preauthorization recovery", () => {
  const source = readFileSync(
    "lib/ebay/ebay-quick-pick-publisher-package-recovery-v1.ts",
    "utf8",
  )
  assert.match(source, /"FAILED_BLOCKED"/)
  assert.match(source, /"AMBIGUOUS_FAIL_CLOSED"/)
