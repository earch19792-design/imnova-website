...
test("Commercial Monitor crea tarea in-app y nunca aplica o envía la mejora por WhatsApp", () => {
  ...
  assert.match(service, /whatsappEnqueued: false/)
  ...
  assert.doesNotMatch(service, /channel: "whatsapp"[\s\S]{0,500}postPublicationDiagnostic/)
})
