...
test("one small visible source requests more authorized views before provider spend", async () => {
  const input = fixture()
...
test("a weak alternate cannot substitute for confirmed multi-pack contents", async () => {
  const input = fixture()
...
test("a bounded enhancement still cannot replace a second authorized view", async () => {
  const input = fixture()
