...
const opportunityPage = read("../../app/admin/ebay/opportunity-queue/research/normal-research-page.tsx")
...
test("strategic surfaces are Preview-bound, persistence-safe, and explicit about activation", () => {
  ...
  assert.match(strategicRoute, /loadSellerOsAssistantMonitorSnapshotV1/)
