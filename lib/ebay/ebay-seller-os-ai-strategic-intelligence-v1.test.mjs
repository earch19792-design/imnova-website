...
test("unconfigured runtime never presents empty portfolio, experiments, or stock as proven zero", () => {
  ...
  assert.equal(bundle.portfolio.state.humanReviewBurden, null)
  assert.equal(bundle.operationalBurden.manualReviewCount, null)
  assert.equal(bundle.operationalBurden.manualReviewRate, null)
