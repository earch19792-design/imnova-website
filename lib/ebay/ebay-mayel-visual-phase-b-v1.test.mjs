...
test("Phase B surface is owner-only, read-only on GET, one-shot, and Trading is explicitly gated", () => {
  ...
  assert.match(ui, /Autorizar actualización de imágenes/)
  assert.match(ui, /Actualizar vista previa con las imágenes vigentes de eBay/)
