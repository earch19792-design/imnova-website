...
test("the isolated command catalog adds only bounded read-only list", () => {
  assert.deepEqual(mcp.match(
    /"seller_os_(?:(?:request|get|resume)_pre_research_batch|list_pre_research_batches)"/g), [
