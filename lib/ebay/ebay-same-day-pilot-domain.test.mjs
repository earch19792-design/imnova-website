...
test("automation is durable, one-click, auto-resuming and has no eBay-write path", async () => {
  const [migration, hardening, stateHardening, leasePreflight, claimSerialization, atomicGates, candidateCycles, schedulerEndpointPin, service, home, liveMonitor, capture, cron, workflow, route, handoff] = await Promise.all([
