  ...
  return `
    <GetItemResponse xmlns="urn:ebay:apis:eBLBaseComponents">
      ...
      <Item>
        ...
        <Title>Contenido que no se debe persistir</Title>
...
test("verifica el seller autenticado y extrae sólo defaults operativos", () => {
...
test("el conector ejecuta exclusivamente OAuth, GetUser y GetItem", async () => {
  ...
  try {
    ...
    assert.doesNotMatch(
      ...
      /Title|Description|PictureURL|ItemSpecifics/,
    )
