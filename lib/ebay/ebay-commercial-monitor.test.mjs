...
} from "./ebay-seller-traffic-report.ts"
import {
...
test("panel expone dry run, bloquea persistencia y exige confirmación", () => {
  ...
  assert.match(panel, /BLOQUEADO EN PILOT MODE/)
  assert.match(panel, /actualización persistente, las alertas y todas las acciones automáticas[\s\S]*bloqueadas por SINGLE_PRODUCT_LAB/)
  ...
  assert.match(panel, /No se puede autorizar automatización durante el piloto/)
...
const PILOT_BLOCKED_REQUESTS = [
  {
    label: "same-day start",
    pathname: "/api/admin/ebay/same-day-pilot",
    method: "POST",
    body: { action: "start" },
    effect: "ebay",
  },
  {
    label: "same-day resume",
    pathname: "/api/admin/ebay/same-day-pilot",
    method: "POST",
    body: { action: "resume" },
    effect: "ebay",
  ...
  {
    label: "same-day continuity rescue",
    pathname: "/api/admin/ebay/same-day-pilot",
    method: "POST",
    body: { action: "continuity_rescue" },
    effect: "ebay",
  },
  {
    label: "same-day cron",
    pathname: "/api/cron/ebay-same-day-pilot",
    method: "GET",
    effect: "ebay",
  },
  {
    label: "automatic 3/6/12 importer",
    pathname: "/api/admin/ebay/luna-product-import",
    method: "POST",
    body: { action: "import" },
    effect: "ebay",
  },
  ...
  {
    label: "reference-guided image preparation",
    pathname: "/api/admin/ebay/images",
    method: "POST",
    body: { action: "reference_guided_prepare" },
    effect: "openai",
  },
  {
    label: "active image revision",
    pathname: "/api/admin/ebay/images",
    method: "POST",
    body: { action: "apply_active_revision" },
    effect: "openai",
  },
  {
    label: "reference-guided canary",
    pathname: "/api/admin/ebay/images/reference-guided-canary",
    method: "POST",
    body: {},
    effect: "openai",
  },
  {
    label: "listing AI generation",
    pathname: "/api/admin/ebay/listing-ai/generate",
    method: "POST",
    body: {},
    effect: "openai",
  },
  {
    label: "listing factory",
    pathname: "/api/admin/ebay/listing-factory",
    method: "POST",
    body: {},
    effect: "openai",
  },
  {
    label: "strategic advisor learning",
    pathname: "/api/admin/ebay/strategic-advisor",
    method: "POST",
    body: {},
    effect: "openai",
  },
  ...
  {
    label: "unpublished offer authorization",
    pathname: "/api/admin/ebay/unpublished-offer-authorization",
    method: "POST",
    body: {},
    effect: "ebay",
  },
  {
    label: "publication OAuth",
    pathname: "/api/admin/ebay/publication-oauth/start",
    method: "POST",
    body: {},
    effect: "ebay",
  },
  {
    label: "commercial improvement preparation",
    pathname: "/api/admin/ebay/commercial-monitor",
    method: "POST",
    body: { action: "prepare_improvement" },
    effect: "ebay",
  },
  {
    label: "commercial improvement application",
    pathname: "/api/admin/ebay/commercial-monitor",
    method: "POST",
    body: { action: "apply_improvement" },
    effect: "ebay",
  },
  {
    label: "persistent commercial run",
    pathname: "/api/admin/ebay/commercial-monitor",
    method: "POST",
    body: { action: "run", dryRun: false },
    effect: "whatsapp",
  },
  {
    label: "commercial scheduler authorization",
    pathname: "/api/admin/ebay/commercial-monitor",
    method: "POST",
    body: { action: "authorize_scheduler" },
    effect: "whatsapp",
  },
  {
    label: "commercial unknown action fails closed",
    pathname: "/api/admin/ebay/commercial-monitor",
    method: "POST",
    body: {},
    effect: "ebay",
  },
  {
    ...
    pathname: "/api/admin/ebay/listing-optimization",
    method: "POST",
    body: {},
    effect: "ebay",
  },
  {
    ...
    pathname: "/api/admin/ebay-winner-pipeline/price-intelligence",
    method: "POST",
    body: { action: "reprocess" },
    effect: "ebay",
  },
  {
    label: "active title application",
    pathname: "/api/admin/ebay/command-center",
    method: "POST",
    body: { action: "active_title_apply" },
    effect: "ebay",
  },
  {
    label: "command center missing action fails closed",
    pathname: "/api/admin/ebay/command-center",
    method: "POST",
    body: null,
    effect: "ebay",
  ...
  {
    label: "automatic learning cron",
    pathname: "/api/cron/ebay-seller-performance-learning",
    method: "GET",
    effect: "openai",
  },
  {
    label: "WhatsApp admin delivery",
  ...
  {
    label: "WhatsApp outbox dispatcher",
    pathname: "/api/cron/commercial-alert-dispatcher",
    method: "GET",
    effect: "whatsapp",
  },
  {
    label: "mass Luna scan",
    pathname: "/api/cron/ebay-luna-opportunity-scan",
    method: "GET",
    effect: "ebay",
  },
  {
    label: "mass Radar sync",
    pathname: "/api/cron/market-radar-luna-sync",
    method: "GET",
    effect: "ebay",
  },
  {
    label: "mass opportunity queue",
    pathname: "/api/admin/ebay/luna-opportunity-queue",
    method: "POST",
    body: {},
    effect: "ebay",
  },
  {
    label: "winner pipeline candidate processing",
    pathname: "/api/admin/ebay-winner-pipeline",
    method: "POST",
    body: { action: "process_radar_candidate" },
    effect: "ebay",
  },
  {
    label: "market radar sync",
    pathname: "/api/admin/market-radar",
    method: "POST",
    body: { action: "sync_lunaportex" },
    effect: "ebay",
  },
  {
    label: "market radar notification",
    pathname: "/api/admin/market-radar",
    method: "POST",
    body: { action: "notify_ebay_opportunities" },
    effect: "whatsapp",
  },
  {
    label: "continuation queue",
  ...
  {
    label: "fulfillment submitter",
    pathname: "/api/cron/marketplace-fulfillment-submitter",
    method: "GET",
    effect: "ebay",
  },
  {
    label: "marketplace tracking approval",
    pathname:
      "/api/admin/marketplace/fulfillment/tasks/task-id/approve-tracking-submission",
    method: "POST",
    body: {},
    effect: "ebay",
  },
  {
    label: "commercial orders OAuth callback",
    pathname: "/api/admin/ebay/commercial-orders-oauth/callback",
    method: "GET",
    effect: "ebay",
  },
  {
    label: "fulfillment OAuth start",
    pathname: "/api/admin/ebay/fulfillment-tracking-oauth/start",
    method: "POST",
    body: {},
    effect: "ebay",
  },
  {
    label: "fulfillment OAuth callback",
    pathname: "/api/admin/ebay/fulfillment-tracking-oauth/callback",
    method: "GET",
    effect: "ebay",
  },
]

test("SINGLE_PRODUCT_LAB bloquea fail-closed todos los efectos automáticos", () => {
  for (const request of PILOT_BLOCKED_REQUESTS) {
    const blocked = evaluateSingleProductLabRequest(request)
    assert.ok(blocked, request.label)
    assert.equal(blocked.status, 423, request.label)
    const payload = singleProductLabBlockedPayload(blocked)
    assert.equal(payload.success, false, request.label)
    assert.equal(payload.error, "SINGLE_PRODUCT_LAB_ACTION_BLOCKED", request.label)
    assert.equal(payload.safety.ebayWrites, 0, request.label)
    assert.equal(payload.safety.openAiCalls, 0, request.label)
    assert.equal(payload.safety.whatsappCalls, 0, request.label)
    assert.equal(payload.safety.publications, 0, request.label)
    assert.equal(payload.safety.repricingActions, 0, request.label)
    assert.equal(payload.safety.automaticLearningRuns, 0, request.label)
  }
})

test("los adapters prohibidos conservan cero llamadas detrás del guard", () => {
  const calls = { ebay: 0, openai: 0, whatsapp: 0 }
  for (const request of PILOT_BLOCKED_REQUESTS) {
    const blocked = evaluateSingleProductLabRequest(request)
    if (!blocked) calls[request.effect] += 1
  }
  assert.deepEqual(calls, { ebay: 0, openai: 0, whatsapp: 0 })
})

test("SINGLE_PRODUCT_LAB conserva sólo las lecturas explícitamente permitidas", () => {
  const allowed = [
    { pathname: "/api/admin/market-radar", method: "GET" },
    { pathname: "/api/admin/ebay/same-day-pilot", method: "GET" },
    {
      pathname: "/api/admin/market-radar",
      method: "POST",
      body: { action: "confirm_stock_quantity" },
    },
    { pathname: "/api/admin/ebay/active-listings/sync", method: "POST" },
    { pathname: "/api/admin/ebay/seller-performance", method: "GET" },
    { pathname: "/api/admin/ebay/seller-whatsapp-alerts", method: "GET" },
    {
      pathname: "/api/admin/ebay/commercial-monitor",
      method: "POST",
      body: { action: "run", dryRun: true },
    },
    {
      pathname: "/api/admin/ebay/commercial-monitor",
      method: "POST",
      body: { action: "compare_seller_hub" },
    },
    {
      pathname: "/api/admin/ebay/command-center",
      method: "POST",
      body: { action: "save_review" },
    },
    {
      pathname: "/api/admin/ebay-winner-pipeline",
      method: "POST",
      body: { action: "record_decision" },
    },
  ]
  for (const request of allowed) {
    assert.equal(
      evaluateSingleProductLabRequest(request),
      null,
...
test("métricas unavailable se distinguen de un cero oficial", () => {
  assert.equal(formatSingleProductLabMetric(null), SINGLE_PRODUCT_LAB_UNAVAILABLE)
  assert.equal(
    formatSingleProductLabMetric(undefined),
    SINGLE_PRODUCT_LAB_UNAVAILABLE,
  )
  assert.equal(formatSingleProductLabMetric(Number.NaN), SINGLE_PRODUCT_LAB_UNAVAILABLE)
  assert.equal(formatSingleProductLabMetric(0), "0")

  const officialZero = normalizeEbaySellerTrafficReport(analyticsReport({
    impressions: 0,
    searchImpressions: 0,
    searchViews: 0,
    views: 0,
  ...
  assert.equal(officialZero.summary.totalImpressions, 0)
  assert.equal(officialZero.summary.totalViews, 0)
  assert.equal(officialZero.summary.transactions, 0)
})

test("la contención corre server-side antes de auth y cubre crons y queues", () => {
  const middleware = readFileSync("middleware.ts", "utf8")
  const queueRoute = readFileSync(
    "app/api/queues/ebay-listing-top20-continuation/route.ts",
    "utf8",
  )
  const guardPosition = middleware.indexOf(
    "evaluateSingleProductLabRequest({",
  )
  const boundaryPosition = middleware.indexOf(
    "getEbayProRuntimeBoundary({",
  )
  const authPosition = middleware.indexOf("isVerifiedAdminToken(token)")
  assert.ok(guardPosition >= 0)
  assert.ok(guardPosition < boundaryPosition)
  assert.ok(guardPosition < authPosition)
  assert.match(middleware, /"\/api\/cron\/:path\*"/)
  assert.match(middleware, /"\/api\/queues\/:path\*"/)
  assert.match(middleware, /"\/api\/admin\/marketplace\/:path\*"/)
  assert.match(queueRoute, /evaluateSingleProductLabRequest/)
  assert.match(queueRoute, /if \(pilotBlock\) return/)
  assert.match(
    queueRoute,
    /Response\.json\(singleProductLabBlockedPayload\(pilotBlock\)/,
  )
  assert.ok(
    queueRoute.indexOf("if (pilotBlock) return") <
      queueRoute.indexOf("continueListingAiApprovalQueueScanFromQueue({"),
  )
})

test("commercial dry run queda limitado a readers y sin WhatsApp", () => {
  const route = readFileSync(
    "app/api/admin/ebay/commercial-monitor/route.ts",
    "utf8",
  )
  assert.match(route, /SINGLE_PRODUCT_LAB_READ_LANES/)
  assert.match(route, /"orders",\s*"analytics",\s*"watchers"/s)
  assert.match(route, /triggerSource:\s*"dry_run"/)
  assert.match(route, /dispatchWhatsApp:\s*false/)
  assert.match(route, /dryRunWhatsApp:\s*true/)
})

test("Seller Hub no contiene fallback sintético y la UI muestra el modo piloto", () => {
  ...
  const performance = readFileSync(
    "app/admin/ebay/seller-performance/page.tsx",
    "utf8",
  )
  ...
  assert.doesNotMatch(reconciliation, /input\.evidence\s*\?\?/)
  assert.doesNotMatch(
    reconciliation,
    /impressions:\s*18[\s\S]{0,120}views:\s*1[\s\S]{0,120}transactions:\s*0[\s\S]{0,120}ctr:\s*5\.6/,
  )
  assert.doesNotMatch(panel, /1\s*\/\s*18/)
  assert.doesNotMatch(panel, /366543596425/)
  assert.doesNotMatch(panel, /SINGLE_PRODUCT_LAB_BANNER/)
  assert.match(
    panel,
    /readers\.orders\?\.status === "available"[\s\S]*metrics\?\.newSales[\s\S]*: null/,
  )
  assert.doesNotMatch(performance, /SINGLE_PRODUCT_LAB_BANNER/)
  assert.match(performance, /completeDashboardMetric/)
  assert.match(performance, /row\.applicability\[key\] === true/)
  assert.match(adminLayout, /SINGLE_PRODUCT_LAB_BANNER/)
  assert.match(adminLayout, /pathname === "\/admin"/)
  assert.match(adminLayout, /pathname === "\/admin\/ebay-seller-os"/)
  assert.match(adminLayout, /pathname\.startsWith\("\/admin\/ebay\/"\)/)
  assert.match(adminLayout, /showPilotBanner &&/)
  assert.match(adminLayout, /aria-hidden="true"[\s\S]*h-\[4\.5rem\]/)
  assert.doesNotMatch(adminLayout, /pathname === "\/admin\/login"/)
  assert.equal(
    SINGLE_PRODUCT_LAB_BANNER,
...
test("Inicio Seller OS reemplaza toda automatización alcanzable por el lock informativo del piloto", () => {
  const today = readFileSync("app/admin/today-launch-panel.tsx", "utf8")
  const home = readFileSync("app/admin/page.tsx", "utf8")
  const wrapper = today.slice(
    today.indexOf("export function TodayLaunchPanel"),
    today.indexOf("function SingleProductLabLaunchLock"),
  )
  const pilotLock = today.slice(
    today.indexOf("function SingleProductLabLaunchLock"),
    today.indexOf("function AutomatedTodayLaunchPanel"),
  )

  assert.match(wrapper, /return <SingleProductLabLaunchLock\s*\/>/)
  assert.doesNotMatch(wrapper, /\bfetch\s*\(|\brequest\s*\(|onClick=/)
  assert.match(
    pilotLock,
  ...
  assert.match(pilotLock, /href="\/admin\/ebay\/strategy-lab"/)
  assert.doesNotMatch(
    pilotLock,
    /<button|\bfetch\s*\(|\bsupabase\.|onClick=|method:\s*"POST"/,
  )
  assert.doesNotMatch(today, /export function AutomatedTodayLaunchPanel/)
  assert.doesNotMatch(home, /Seller OS trabaja en segundo plano/)
  assert.match(home, /Seller OS permanece en análisis read-only/)
})

test("un 423 residual se presenta como contención correcta con reason y mode", () => {
  const today = readFileSync("app/admin/today-launch-panel.tsx", "utf8")
  ...
  assert.equal(payload.reason, "SAME_DAY_AUTOMATION_BLOCKED")
  assert.equal(payload.mode, "SINGLE_PRODUCT_LAB")
  assert.match(
    today,
  ...
  assert.match(today, /payload\.reason/)
  assert.match(today, /payload\.mode/)
  assert.match(today, /pilotErrorMessage\(payload\)/)
})
