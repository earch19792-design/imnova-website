...
export const LUNA_SHIPPING_RUNTIME_TRACE_STATES = Object.freeze([
  ...
  "CANONICAL_FINGERPRINT_COMPUTED", "CANONICAL_FINGERPRINT_WRITE",
  "CANONICAL_FINGERPRINT_READBACK", "CANONICAL_DESTINATION_MATCH",
...
const TRACE_EVENT_KEYS = new Set([
  ...
  "state", "subtotalUsd", "success", "timestamp", "totalUsd", "traceId",
])
