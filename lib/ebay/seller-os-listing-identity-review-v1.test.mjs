...
test("a supplier identity already linked to another live Item stays in owner review", () => {
  const queue = buildListingIdentityReviewQueueV1({
    cases: [
      { ...listing("366666581320", "IMN-LST-000027", "LINKED_EXACT"),
        luna_product_id: "9220815749344", luna_variant_id: "48809620930784" },
      listing("366597434810", "IMN-LST-000025", "MISSING_LUNA_IDENTITY"),
    ],
    catalog: [{ product_id: "9220815749344", variant_id: "48809620930784",
      sku: "ITEM5195", preflight_status: "PREFLIGHT_PASS" }],
    decisions: [{ ebay_item_id: "366597434810", ebay_sku: "IMN-LST-000025",
      luna_product_id: "9220815749344", luna_variant_id: "48809620930784",
      luna_sku: "ITEM5195", decision: "APPROVE_EXACT_LINKAGE",
      decision_version: 1, evidence_observed_at: "2026-08-24T06:33:13Z" }],
    packages: [], opportunities: [],
  })
  assert.equal(queue.length, 1)
  assert.equal(queue[0].reasonCode, "ACTIVE_SUPPLIER_IDENTITY_ALREADY_LINKED")
})
