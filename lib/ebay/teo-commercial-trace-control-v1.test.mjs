...
test("canonical engine accepts only an exact unused preauthorized trace row", () => {
  ...
  assert.match(engine, /reserved\.data\.state !== "RUNNING"/)
  assert.match(engine, /reserved\.data\.event_count !== 0/)
})
