...
test("the runtime accepts only proven capture-compatible artifacts and names restart support", () => {
  assert.deepEqual(EBAY_ONE_CLICK_RESEARCH_EXTENSION_ARTIFACT, {
    ...
    artifactSha256: "a105de6ad08996efe0cc604f2833ba1211a2c1c9b18b76e5f522d4baa7a30455",
    sourceTreeSha256: "4997928823a6b2e26c75805640fd3c193e5ebca95b09a1c88f078ce01130ba87",
  ...
  assert.deepEqual(attestEbayOneClickResearchExtensionArtifact({
    extensionVersion: "1.2.39", extensionId: "ajplldjfkdgigcibbplcffhafendcnei",
    manifestOriginMatch: true,
  }), {
    extensionVersion: "1.2.39",
    buildId: "a105de6ad08996efe0cc604f2833ba1211a2c1c9b18b76e5f522d4baa7a30455",
    artifactSha256: "a105de6ad08996efe0cc604f2833ba1211a2c1c9b18b76e5f522d4baa7a30455",
    sourceTreeSha256: "4997928823a6b2e26c75805640fd3c193e5ebca95b09a1c88f078ce01130ba87",
    extensionId: "ajplldjfkdgigcibbplcffhafendcnei",
...
test("v1.2.39 worker boot recovers existing tabs and remains idempotent across restarts", async () => {
  const manifest = JSON.parse(readFileSync(
    "tools/browser-extensions/ebay-product-research-capture/manifest.json", "utf8",
  ))
