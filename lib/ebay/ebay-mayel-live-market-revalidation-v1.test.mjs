...
const evidenceQualityMigration = readFileSync(
  "supabase/migrations/20260919090000_pre_research_evidence_quality_v1.sql",
  "utf8")
...
test("durable RPC rejects HIGH or MEDIUM without accepted comparables", () => {
  assert.match(evidenceQualityMigration,
  ...
  assert.match(evidenceQualityMigration, /set search_path = ''/)
  assert.match(evidenceQualityMigration,
