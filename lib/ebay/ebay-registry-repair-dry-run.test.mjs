...
test("known inactive repair row is a lifecycle precondition, not identity ambiguity", () => {
  const fixture = certifiedFixture()
  fixture.registryRows[0].listing_status = "stale"
  const result = build(fixture)
...
test("Registry active lifecycle signal uses canonical trimmed normalization", () => {
  const fixture = certifiedFixture()
