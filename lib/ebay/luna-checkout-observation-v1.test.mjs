...
import { canonicalDestinationMatchStatusV1 as match, checkoutObservationV1 as project, compactCheckoutObservationV1 as compact } from './luna-checkout-observation-v1.ts'
...
test('probe stays read-only; certified acquisition still requires fresh capability and its bounded permit',()=>{
 ...
 assert.match(acquisition,/captureProbe\?\.captureAvailable !== true/)
