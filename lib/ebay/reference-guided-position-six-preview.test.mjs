...
test("workspace renders reviewable or rejected position 6 evidence with immutable identity", () => {
  assert.match(workspace, /\["QA_PENDING", "BLOCKED_FIDELITY"\]/)
  assert.match(workspace, /Secundaria 6 · SECONDARY_HUMAN_CONTEXT/)
  assert.match(workspace, /evidencia humana preservada/)
