...
import { projectEbayFeePerformanceV1, feeContextSafeErrorV1 } from "./ebay-fee-context-domain-v1.ts"
    ...
    for (const status of [200, 204, 429]) {
      ...
      globalThis.fetch = async (url, init) => {
        ...
        if (String(url).endsWith("/ws/api.dll")) {
          ...
          return new Response("<GetUserResponse><Ack>Success</Ack><User><UserID>fixture-seller</UserID><RegistrationAddress><Country>US</Country></RegistrationAddress></User></GetUserResponse>")
        }
