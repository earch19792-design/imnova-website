...
test("future Quick Picks use the same bounded continuation without SKU cases", async () => {
  ...
  assert.match(route, /continueLunaQuickPickExactSoldEnrichmentV1/)
  assert.ok(route.indexOf("continueLunaQuickPickRequiredSpecificsV1({") <
    route.indexOf("continueLunaQuickPickExactSoldEnrichmentV1({"))
