...
export async function readEbayFeeContextReadonlyV1(itemId: string) {
  ...
  return {
    ...
    listing: { categoryId: listing.safeDefaults.categoryId ?? null,
      categoryPath: listing.categoryPath ?? null, saleFormat: listing.saleFormat ?? null,
      secondaryCategoryId: listing.secondaryCategoryId ?? null,
