...
test("GetItem identity parser reads official facts but never competitor Custom Label or SKU", () => {
  ...
  assert.deepEqual(parsed.itemSpecifics.find((specific) => specific.name === "brand"), {
    name: "brand", values: ["Lysol"],
  })
...
test("Trading never selects the first value from an unresolved multi-variation listing", () => {
  ...
  assert.deepEqual(parsed.itemSpecifics.find((specific) => specific.name === "color")?.values, ["Red", "Blue"])
})
