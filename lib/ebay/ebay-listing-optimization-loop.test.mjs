...
test("Admin route and interface remain authenticated and non-publishing", () => {
  ...
  assert.match(page, /Aprobar título/)
  assert.match(page, /Aprobar precio/)
  assert.match(page, /Image Brief · seis imágenes/)
  assert.match(page, /Iniciar experimento/)
})
