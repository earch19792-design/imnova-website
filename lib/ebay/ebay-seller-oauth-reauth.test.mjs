...
test("temporary route/page are isolated and never import mutable OAuth or writers", () => {
  ...
  assert.match(route,
    /REJECTION_REASON: registryRepairDryRun\.DRY_RUN_REJECTION_REASON,\s*AMBIGUITY_CLASS: registryRepairDryRun\.AMBIGUITY_CLASS,\s*\}, \{\s*status: 409/)
  ...
  assert.doesNotMatch(page,
    /EVIDENCE_UNAVAILABLE|SAME_REQUEST_EVIDENCE_INCOHERENT/)
