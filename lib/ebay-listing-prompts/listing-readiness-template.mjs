  ...
  blocking_rules: [
    {
      ...
      severity:
        "block",
      message:
        "Before preparing a new listing, review active eBay listings for out-of-stock, price-up, stale mapping, broken margin, or cancellation risk. Protect active listings before pursuing new opportunities.",
    },
    {
      field:
        "confirmed_stock",
