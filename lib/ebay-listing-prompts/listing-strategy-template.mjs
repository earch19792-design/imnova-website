export const listingStrategyTemplate = {
  ...
  final_review_order: [
    "Confirm active eBay listing risks first: out-of-stock, price-up, stale mapping, broken margin, or cancellation risk must be reviewed before new listing prep.",
