-- Expose the already-certified family price-distribution references through
-- the existing service-role Radar read contract. Direct table reads remain
-- revoked; this does not add a store, scheduler, pipeline or state machine.
