...
const workStreams = [
  {
    ...
    description:
      "Desarrollo de fórmulas, formatos y experiencias de consumo pensadas para bienestar diario, nutrición funcional y hábitos modernos.",
    icon: HeartPulse,
  },
  {
    title: "Marcas y productos",
    description:
      "Construcción de líneas comerciales con identidad premium, packaging, canales y narrativa lista para mercado.",
    icon: Boxes,
  },
  {
    title: "Sistemas inteligentes",
    description:
      "Automatización, datos y herramientas internas para acelerar decisiones, seguimiento y ejecución del ecosistema.",
    icon: Bot,
  },
  {
    title: "Comunidad",
    description:
      "Activación de usuarios, feedback, contenido y experiencias para que la familia IMNOVA participe en lo que viene.",
    icon: Users,
  },
  {
    title: "Canales de venta",
    description:
      "Tienda, ecommerce, marketplaces y rutas de distribución para mover productos desde lanzamiento hasta escala.",
    icon: Network,
  },
  {
    title: "Expansión",
    description:
      "Preparación del ecosistema para crecer en Latinoamérica, Norteamérica y nuevos mercados digitales.",
    icon: Globe2,
  },
]
      ...
      <div className="relative z-10 mx-auto max-w-7xl px-6">
        ...
        >
          ...
          <p className="mx-auto mt-8 max-w-3xl text-lg leading-8 text-zinc-400">
            Esta sección resume cómo avanza IMNOVA en nutrición funcional,
            tecnología, bienestar, comunidad y canales comerciales. Los productos específicos
