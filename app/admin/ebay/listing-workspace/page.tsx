        ...
        {opportunity && listingPackage && <>
          <section className="rounded-3xl border border-emerald-200/25 bg-emerald-200/[0.06] p-4">
            ...
            <div className="mt-3 grid gap-2 sm:grid-cols-2">
              ...
              <a href="https://www.ebay.com/sl/sell" className="inline-flex min-h-12 items-center justify-center rounded-2xl border border-cyan-200/30 px-4 text-center text-sm font-black text-cyan-50">2. Abrir Create listing en Seller Hub</a>
            </div>
