    ...
    <article className="min-w-0 space-y-5">
      ...
      <DossierSection id="dossier-economics" title="Economics" icon={DollarSign}>
        <DefinitionGrid items={[
          ...
          ["Política FVF oficial", display(dossier.economics.feePolicyAuthority.status)],
          ["Vínculo categoría eBay", display(dossier.economics.feePolicyAuthority.categoryBindingStatus)],
          ["Importe fee final", display(dossier.economics.feeAmountAuthority.status)],
          ["Fee prelisting conservador", display(dossier.economics.conservativeFeeAuthority.status)],
          ["FVF categoría oficial", money(dossier.economics.conservativeFeeAuthority.officialCategoryFvf)],
          ["Fee por orden", money(dossier.economics.conservativeFeeAuthority.perOrderFee)],
          ["Estado Service Metrics", display(asRecord(dossier.economics.conservativeFeeAuthority.serviceMetricsAuthority).status)],
          ["Reserva Service Metrics", money(dossier.economics.conservativeFeeAuthority.serviceMetricsReserve)],
          ["Estado reserva comprador", display(asRecord(dossier.economics.conservativeFeeAuthority.buyerDependentFeeReserve).status)],
          ["Reserva fee dependiente del comprador (no impuesto)", money(asRecord(dossier.economics.conservativeFeeAuthority.buyerDependentFeeReserve).amountUsd)],
          ["Costos conservadores", money(dossier.economics.conservativeEconomics.totalConservativeCosts)],
          ["Utilidad bajo reserva", money(dossier.economics.conservativeEconomics.netProfitUnderBound)],
          ["Piso económico conservador", money(dossier.economics.conservativeEconomics.economicFloor)],
          ["Precio prelisting seguro", dossier.economics.conservativeEconomics.prelistingPriceSafe === true ? "Sí, escenario acotado" : "No demostrado"],
