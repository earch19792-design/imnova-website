...
export default function OperationalReadinessPage() {
  ...
  const [whatsappResult, setWhatsappResult] = useState<Record<string, unknown> | null>(null)
  ...
  async function previewWhatsApp() {
    ...
    try {
      ...
      setWhatsappResult(result.result ?? null)
  ...
  const humanPreview = whatsappResult?.humanPreview as HumanPreview | undefined
    ...
    <div className="mx-auto max-w-7xl space-y-4">
      ...
      <div className="grid gap-4 xl:grid-cols-[1.1fr_0.9fr]">
        <section className="rounded-2xl border border-slate-200 bg-white p-5">
          ...
          <button disabled={!qualityFile || loading} onClick={importQuality} className="mt-3 inline-flex items-center gap-2 rounded-lg bg-cyan-600 px-4 py-2 text-xs font-bold text-white disabled:opacity-40"><Upload size={14} />Validate and preview</button>
