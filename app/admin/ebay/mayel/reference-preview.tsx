...
function ReferencePreview() {
  ...
  return <section className="mt-5 space-y-5 rounded-xl border p-5" aria-label="Borrador por referencia">
    ...
    {result && <>
      ...
      <p>{result.publicationGate.READY_TO_PUBLISH && result.publicationEvidenceStatus === "READ" ? "Datos completos para revisión OWNER." : "Esperando datos de publicación. Puedes revisar el borrador."}</p>
