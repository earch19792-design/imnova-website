          ...
          <section id="summary" aria-labelledby="summary-heading" className="scroll-mt-4 space-y-4">
            ...
            <div className="grid gap-3 lg:grid-cols-3">
              <article className="rounded-3xl border border-white/10 bg-white/[0.035] p-5">
                ...
                <p className="mt-2 text-xs leading-5 text-white/55">Inventory <Status value={monitor.liveCertification.inventory.status} /> · SKUs {monitor.liveCertification.inventory.inventorySkuCount ?? "UNKNOWN"} · publicados {monitor.liveCertification.inventory.publishedListingCount ?? "UNKNOWN"} · OAuth {monitor.liveCertification.inventory.oauthSafeErrorCategory ?? (monitor.liveCertification.inventory.status === "AVAILABLE" ? "NO_CLASSIFIED_OAUTH_ERROR" : "UNKNOWN")}</p>
                ...
                {monitor.discoveryCoverage.reconciliation && <>
                  ...
                  <p className="mt-2 text-[11px] text-white/45">Inventory comparison <Status value={monitor.discoveryCoverage.reconciliation.inventory.status} /> · ofertas {monitor.discoveryCoverage.reconciliation.inventory.publishedOfferIdentityCount ?? "UNKNOWN"} · fuera de seller-wide {monitor.discoveryCoverage.reconciliation.inventory.inventoryOffersNotInSellerWideEnumerationCount ?? "UNKNOWN"} · US live fuera de Inventory {monitor.discoveryCoverage.reconciliation.inventory.liveUsCertifiedNotInInventoryCount ?? "UNKNOWN"} · grain {monitor.discoveryCoverage.reconciliation.inventory.comparisonGrain}</p>
