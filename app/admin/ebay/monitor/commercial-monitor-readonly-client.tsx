          ...
          <section id="summary" aria-labelledby="summary-heading" className="scroll-mt-4 space-y-4">
            ...
            <div className="grid gap-3 lg:grid-cols-3">
              <article className="rounded-3xl border border-white/10 bg-white/[0.035] p-5">
                ...
                {monitor.discoveryCoverage.dimensions && <p className="mt-2 text-[11px] text-white/45">Marketplace <Status value={monitor.discoveryCoverage.dimensions.marketplaceCertification.status} /> · Inventory capability <Status value={monitor.discoveryCoverage.dimensions.inventoryCapability.status} /> · representation <Status value={monitor.discoveryCoverage.dimensions.inventoryRepresentation.status} /> · Registry <Status value={monitor.discoveryCoverage.dimensions.registryCoverage.status} /> · registry freshness <Status value={monitor.discoveryCoverage.dimensions.registryCoverage.evidenceFreshness} /> · history <Status value={monitor.discoveryCoverage.dimensions.historicalDiscoveryEvidence.freshness} /></p>}
                <p className="mt-2 text-xs leading-5 text-white/55">Inventory read <Status value={monitor.liveCertification.inventory.status} /> · capability <Status value={monitor.liveCertification.inventory.capabilityStatus} /> · SKUs {monitor.liveCertification.inventory.inventorySkuCount ?? "UNKNOWN"} · publicados {monitor.liveCertification.inventory.publishedListingCount ?? "UNKNOWN"} · OAuth {monitor.liveCertification.inventory.oauthSafeErrorCategory ?? (monitor.liveCertification.inventory.capabilityStatus === "AVAILABLE" ? "NO_CLASSIFIED_OAUTH_ERROR" : "UNKNOWN")}</p>
                <p className="mt-2 text-[11px] text-white/45">Inventory representation · representados {monitor.liveCertification.inventory.representation.representedCount ?? "UNKNOWN"} · no representados {monitor.liveCertification.inventory.representation.notRepresentedCount ?? "UNKNOWN"} · identidad no resuelta {monitor.liveCertification.inventory.representation.identityUnresolvedCount ?? "UNKNOWN"} · fuente no concluyente {monitor.liveCertification.inventory.representation.sourceUnprovenCount ?? "UNKNOWN"} · grain {monitor.liveCertification.inventory.representation.classificationGrain}</p>
                <p className="mt-2 text-[11px] text-white/45">{monitor.liveCertification.inventory.gapCodes.map(shortCode).join(" · ") || "Sin gaps Inventory declarados"}</p>
                {monitor.discoveryCoverage.reconciliation && <>
                  <p className="mt-2 text-[11px] text-white/45">Seller-wide <Status value={monitor.discoveryCoverage.reconciliation.sellerWide.status} /> · reportados {monitor.discoveryCoverage.reconciliation.sellerWide.reportedItemCount ?? "UNKNOWN"} · parseados {monitor.discoveryCoverage.reconciliation.sellerWide.parsedItemCount ?? "UNKNOWN"} · particionados {monitor.discoveryCoverage.reconciliation.sellerWide.partitionedItemCount ?? "UNKNOWN"} · US representados {monitor.discoveryCoverage.reconciliation.sellerWide.representedUsItemCount ?? "UNKNOWN"}</p>
                  <p className="mt-2 text-[11px] text-white/45">Inventory comparison <Status value={monitor.discoveryCoverage.reconciliation.inventory.status} /> · representados {monitor.discoveryCoverage.reconciliation.inventory.representedCount ?? "UNKNOWN"} · no representados {monitor.discoveryCoverage.reconciliation.inventory.notRepresentedCount ?? "UNKNOWN"} · identidad no resuelta {monitor.discoveryCoverage.reconciliation.inventory.identityUnresolvedCount ?? "UNKNOWN"} · fuente no concluyente {monitor.discoveryCoverage.reconciliation.inventory.sourceUnprovenCount ?? "UNKNOWN"} · ofertas {monitor.discoveryCoverage.reconciliation.inventory.publishedOfferIdentityCount ?? "UNKNOWN"} · fuera de seller-wide {monitor.discoveryCoverage.reconciliation.inventory.inventoryOffersNotInSellerWideEnumerationCount ?? "UNKNOWN"} · grain {monitor.discoveryCoverage.reconciliation.inventory.comparisonGrain}</p>
                  <p className="mt-2 text-[11px] text-white/45">Registry comparison <Status value={monitor.discoveryCoverage.reconciliation.registry.status} /> · Items activos {monitor.discoveryCoverage.reconciliation.registry.activeRegistryItemCount ?? "UNKNOWN"} · registry fuera de seller-wide {monitor.discoveryCoverage.reconciliation.registry.activeRegistryItemsNotInSellerWideEnumerationCount ?? "UNKNOWN"} · US live fuera de registry {monitor.discoveryCoverage.reconciliation.registry.liveUsCertifiedItemsNotInRegistryCount ?? "UNKNOWN"} · grain {monitor.discoveryCoverage.reconciliation.registry.itemGrain}</p>
                  <p className="mt-2 text-[11px] text-white/45">Registry identities · activas {monitor.discoveryCoverage.reconciliation.registry.activeRegistryIdentityCount ?? "UNKNOWN"} · registry fuera de seller-wide {monitor.discoveryCoverage.reconciliation.registry.activeRegistryIdentitiesNotInSellerWideEnumerationCount ?? "UNKNOWN"} · US live fuera de registry {monitor.discoveryCoverage.reconciliation.registry.liveUsCertifiedIdentitiesNotInRegistryCount ?? "UNKNOWN"} · grain {monitor.discoveryCoverage.reconciliation.registry.identityGrain}</p>
                </>}
              </article>
